...
plot3(x3,t*ones(size(x3)),v3,'m')
hold on
plot3(x2,t*ones(size(x2)),[v3(end) v2],'m')
plot3(x1,t*ones(size(x1)),[v3(end) v1],'g')
...
plot3(x3,t*ones(size(x3)),f13,'m')
hold on
plot3(x2,t*ones(size(x2)),[f13(end) f12],'m')
plot3(x1,t*ones(size(x1)),[f13(end) f11],'g')
